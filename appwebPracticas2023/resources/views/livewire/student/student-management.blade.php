        ...
        <div
            ...
            <div class="flex items-center justify-between dark:text-gray-400">
                ...
                <div class="mb-1 ml-10">
                    ...
                    @if ($isOpen)
                        @include('livewire.student.planppp-create')
                    @endif
                </div>
            </div>
            <div class="shadow overflow-x-auto border-b border-gray-200 sm:rounded-lg">
                <table class="w-full divide-y divide-gray-200 table-auto">
                    ...
                    <tbody class="divide-y divide-gray-200 dark:text-gray-400">
                        @foreach ($gestionarplans as $item)
                            <tr class="text-sm font-medium text-gray-900">
                                ...
                                <td class="px-6 py-4">{{ $item->adjuntarplan }}</td>
            ...
            @if (!$gestionarplans->count())
                No existe ningun registro coincidente
            @endif
            <div class="px-6 py-3">
                {{ $gestionarplans->links() }}
            </div>
        </div>
    </div>
