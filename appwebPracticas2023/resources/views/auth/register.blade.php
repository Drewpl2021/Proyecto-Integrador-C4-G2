...
<body
    style="position: relative; background: url('/images/estrellitas1.jpeg') no-repeat center center fixed;
            ...
            <div class="row full-height justify-content-center">
                <div class="col-12 text-center align-self-center py-5">
                    <div class="section pb-5 pt-5 pt-sm-2 text-center">
                        <h6 class="mb-0 pb-3"><span>Registrate</span><span>Iniciar Sesion</span></h6>
                                        ...
                                        <div class="section text-center">
                                            ...
                                            <form method="POST" action="{{ route('register') }}">
                                                ...
                                                <div class="form-group">
                                                    <input id="name" class="form-style block mt-1 w-full" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" placeholder="Full Name">
                                                    <i class="input-icon uil uil-user"></i>
                                                </div>
                                                <div class="form-group mt-2">
                                                    <input id="email" class="form-style block mt-1 w-full" type="email" name="email" :value="old('email')" required autocomplete="username" placeholder="Email">
                                                    <i class="input-icon uil uil-at"></i>
                                                </div>
                                                <div class="form-group mt-2">
                                                    <input id="password" class="form-style block mt-1 w-full" type="password" name="password" required autocomplete="new-password" placeholder="Password">
                                                    <i class="input-icon uil uil-lock-alt"></i>
                                                </div>
                                                <div class="form-group mt-2">
                                                    <input id="password_confirmation" class="form-style block mt-1 w-full" type="password" name="password_confirmation" required autocomplete="new-password" placeholder="Password Confirm">
                                                    <i class="input-icon uil uil-lock-alt"></i>
                                                </div>
                                                <button type="submit" class="btn mt-4 ms-4">
                                                    {{ __('Register') }}
                                                </button>
                                            </form>
                                        </div>
                                    ...
                                    <div class="center-wrap">
                                        <div class="section text-center">
                                            ...
                                            <form method="POST" action="{{ route('login') }}">
                                                @csrf
                                                <div class="form-group">
                                                    <input id="email" class="form-style block mt-1 w-full" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" placeholder="Email">
                                                    <i class="input-icon uil uil-at"></i>
                                                </div>
                                                <div class="form-group mt-2">
                                                    <input id="password" class="form-style block mt-1 w-full" type="password" name="password" required autocomplete="current-password" placeholder="Password">
                                                    <i class="input-icon uil uil-lock-alt"></i>
                                                </div>
